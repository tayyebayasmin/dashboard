  ...
  return (
    <div>
      <Dialog
        ...
        PaperProps={{
          style: {
            minWidth: windowDimenion.winWidth < 450 ? undefined : "700px",
            backgroundColor:
      ...
      >
        ...
        <Box width={windowDimenion.winWidth<450?'95%':"80%"} flexDirection="column" display={"flex"} ml="3%">
          <CustomText
            ml="0px"
        ...
        >
          <Box
            ...
            sx={{
              display: "flex",
              ml: windowDimenion.winWidth < 450 ? "30%" : "10%",
            }}
          >
            <QRCodeCanvas
          ...
          <Box
            width={windowDimenion.winWidth < 450 ? "100%" : "50%"}
            display={"flex"}
            flexDirection="column"
            ml={windowDimenion.winWidth < 450 ? "3%" : undefined}
          >
            <CustomText
              ml="0px"
        ...
        >
          <Button
            sx={{
              ...
              marginTop: windowDimenion.winWidth<450?undefined:"20px",
              borderRadius: "20px",
              alignSelf: "center",
          ...
          <Button
            sx={{
              width:windowDimenion.winWidth<450?"40%": "25%",
              ml: "10px",
              marginTop: windowDimenion.winWidth<450?undefined:"20px",
              background: "#F85844",
              borderRadius: "20px",
